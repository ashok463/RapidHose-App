...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        navigateAlreadyLoggedIn(windowScene: windowScene)
    }
    
    private func navigateAlreadyLoggedIn(windowScene : UIWindowScene){
//        if UserDefaults.standard.bool(forKey: Constants.userDefaulsKeys.isLogin){
//            if let mainVC = AppDelegate.getMainStoryboard().instantiateViewController(identifier: "MainVC") as? MainVC{
